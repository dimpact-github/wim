...
% Define variables
\newcommand{\customer}{Dimpact release 1.10}
...
\begin{tabular}{| r | p{15cm} |}
	\hline \# & Omschrijving \\ \hline \hline
	502 & Aanpassing aan lijstpagina leidt niet tot purge uit Drupal-cache \\ \hline
	557 & [SD-15533] CSS niet geladen na handmatig opschonen cache \\ \hline
    565 & [SD-15582] Rol moet specifiek recht bevatten om Inhoud te kunnen zoeken \\ \hline
	583 & .sass-cache uitschakelen \\ \hline
\end{tabular}
...
\begin{tabular}{| r | p{15cm} |}
	\hline \# & Omschrijving \\ \hline \hline
	488 & Handleiding \\ \hline
	489 & Security updates \\ \hline
\end{tabular}
