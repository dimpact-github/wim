...
% Define variables
\newcommand{\customer}{Dimpact release 1.11}
...
\begin{tabular}{| r | p{15cm} |}
	\hline \# & Omschrijving \\ \hline \hline
		592 & Code Hotjar toevoegen (SD-16233) \\ \hline
\end{tabular}
...
\begin{tabular}{| r | p{15cm} |}
	\hline \# & Omschrijving \\ \hline \hline
	371 & niet alle documenten worden gevonden in Solr \\ \hline
\end{tabular}
...
\begin{tabular}{| r | p{15cm} |}
	\hline \# & Omschrijving \\ \hline \hline
	610 & Change : upgraden hosting omgeving voor SSL offloading \\ \hline
	584 & Release 1.11/ Security updates \\ \hline
\end{tabular}
