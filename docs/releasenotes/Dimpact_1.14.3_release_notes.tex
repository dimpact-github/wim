...
% Define variables
\newcommand{\customer}{Dimpact release 1.14.3}
...
\subsubsection{Display precedence order} % (fold)
...
\end{itemize}
% subsubsection display_precedence_order (end)

\subsubsection{YouTube video instellingen} % (fold)
...
\end{itemize}
% subsubsection youtube_video_instellingen (end)

% subsection ticket_669 (end)
