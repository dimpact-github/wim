...
% Define variables
\newcommand{\customer}{Dimpact release 1.12}
...
\begin{tabular}{| r | p{15cm} |}
	...
	576 & [RFC-124] Webservice koppeling van SDU gebruiken voor WIM \\ \hline
\end{tabular}
...
\begin{tabular}{| r | p{15cm} |}
	\hline \# & Omschrijving \\ \hline \hline
	613 & Release 1.12 / Security updates \\ \hline
	615 & Het rijkshuisstijl theme heeft geen recommended release meer \\ \hline
\end{tabular}
