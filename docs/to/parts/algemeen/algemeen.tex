...
De standaard taal voor Drupal is Engels. De \usemodule{locale} module (uit de Drupal core) zal worden ingezet om andere vertalingen te kunnen laten zien. De Nederlandse vertalingen van Drupal worden ge\"{i}mporteerd voor de modules waarvoor een vertaling beschikbaar is. De vertalingen kunnen in het beheergedeelte van Drupal aangevuld c.q. aangepast worden.
...
Voor de workflow wordt de \usemodule{workbench} module i.c.m. \usemodule{workbench\_moderation} ingezet. Content kan de volgende statussen hebben:
\begin{itemize}
