...
\paragraph{Zoekbox}
Op de zoekresultatenpagina staat de zoekbox zowel in de header als in de linkerkolom. Om het blok dubbel te kunnen gebruiken zullen we gebruik maken van de \usemodule{block\_clone} module. Via de \texttt{bespoke} module zullen we met \emph{preprocess hooks} ervoor zorgen dat het blok niet in de content wordt getoond en dat de zoekopdracht in de zoekbox blijft staan.
