...
Voor de zoekfunctionaliteit wordt gebruik gemaakt van de \usemodule{apachesolr} module. Als uitgangspunt gelden de default settings (dat wil zeggen: configuratiebestanden die meegeleverd worden bij de \texttt{apachesolr} module). Berekeningen en settings van relevantie, synoniemenlijsten etc. wordt ongemoeid gelaten. Het is vaak ook niet noodzakelijk om dit aan te passen aangezien de default settings over het algemeen goede resultaten leveren.
