...
Voor media en wysiwyg gaan we de \usemodule{wysiwyg} en \usemodule{media} / \usemodule{file\_entity} modules inzetten. Als editor zelf wordt gekozen voor \texttt{CKEditor} aangezien dit de meestgebruikte editor is binnen Drupal en standaard is in Drupal 8.
...
Voor het gemakkelijk kunnen toevoegen van links in bodyteksten maken we gebruik van de \usemodule{linkit} module i.c.m. \usemodule{pathologic}.
