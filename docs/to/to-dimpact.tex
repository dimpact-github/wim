...
% Introductie
\include{parts/introductie/introductie}
\include{parts/introductie/basiselementen-terminologie-definities}


% Algemeen
\include{parts/algemeen/algemeen}
\include{parts/algemeen/deployment}
\include{parts/algemeen/performance/performance}

\include{parts/internet/internet}
\include{parts/intranet/intranet}
...
\input{parts/appendices/contenttypes}
\include{parts/appendices/taxonomie}
\include{parts/appendices/views}
%\include{parts/appendices/context}
%\include{parts/appendices/pathauto}
%\include{parts/appendices/referentietabel}
\include{parts/appendices/tools}
