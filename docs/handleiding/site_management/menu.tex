...
Voor de alfabet menu-balk gelden de volgende twee opmerkingen:
\begin{itemize}
\item Op het intranet wordt de inhoud van de alfabet-menu’s niet getoond. De alfabet menu’s zijn alleen voor het internet en niet voor het intranet ingericht.
\item Een link naar het intranet wordt wel op het internet getoond. Als er een link aan het alfabet menu wordt toegevoegd dan zal, ook als dat een link is naar een item op het intranet, die zichtbaar zijn als je als beheerder bent ingelogd. Voor anonieme bezoekers, en accounts met minder rechten, zullen alleen de items op het internet zichtbaar zijn in het alfabet menu. Er zijn twee screenshots toegevoegd, één als anonieme bezoeker, en één ingelogd als admin. De items “Zomaar een testje” en “Zomaar op intranet” zijn items op het intranet.
\end{itemize}
