...
\paragraph{RIS vergaderingen gegroepeerd}

Toont de laatste 5 vergaderingen per bron. Tijdens het toevoegen van dit blok via Felix is er een extra optie beschikbaar naast het invullen van de titel van het blok. Namelijk Argument field data field ris category.field ris category tid. 
Vul hier het id van de categorie in om alle vergaderingen op te halen onder deze categorie. Het id kan opgezocht worden op de pagina \drupalpath{admin/structure/taxonomy/ris_category}.
...
Voor een goede werking van de Google Maps kaart bij het invoeren van enkel adressen is het nodig om de geocoding settings in te stellen\seeone{geocoding}.
