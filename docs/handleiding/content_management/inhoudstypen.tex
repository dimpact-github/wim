...
Het inhoudstype 'onderwerp' kan worden gebruikt om een overzichtspagina te maken van een bepaald onderwerp. Een onderwerppagina verschilt qua blokkenindeling van een normale pagina; zo zijn er hier drie kolommen met een gelijke breedte. Het is mogelijk de body leeg te laten en de pagina te vullen met behulp van editorials.
...
\item Klik onderaan de pagina op de knop \emph{Opslaan} om de inhoud op te slaan.
\end{enumerate}
In \emph{Nieuwe peiling}\seeone{nieuwepeiling} wordt stap voor stap uitgelegd hoe je een nieuwe peiling aanmaakt en laat zien op de website.
