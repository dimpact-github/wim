...
Kies \emph{publiek bestand} als de media publiekelijk beschikbaar moet zijn. Voor media die alleen voor het intranet is bestemd kan het beste worden gekozen voor \emph{afgeschermd bestand}. Afgeschermde bestanden zijn alleen toegankelijk voor ingelogde gebruikers met de rol administrator, eindredacteur, redacteur, teamlid of medewerker.
...
\paragraph{Weergaveformaten voor afbeeldingen}

Bij het toevoegen van afbeeldingen kunnen er meerdere weergaveformaten worden gekozen.

Standaard (532 bij 225):

\includegraphics[scale=0.4]{img/erasmusbrug_standaard.jpg}

Volle breedte (1116 bij 372):

\includegraphics[scale=0.4]{img/erasmusbrug_volle_breedte.jpg}

Banner (363 bij 125):

\includegraphics[scale=0.4]{img/erasmusbrug_banner.jpg}

Overig onderwerp (390 bij 100):

\includegraphics[scale=0.4]{img/erasmusbrug_overig_onderwerp.jpg}

Voorbeeldweergave (180 bij 180):

\includegraphics[scale=0.4]{img/erasmusbrug_voorbeeldweergave.jpg}

Portret (120 bij 120):

\includegraphics[scale=0.4]{img/erasmusbrug_portret.jpg}

Teaser (100 bij 100):

\includegraphics[scale=0.4]{img/erasmusbrug_teaser.jpg}


\paragraph{Afbeeldingen uitlijnen} % (fold)
\label{par:afbeeldingen_uitlijnen}
Afbeeldingen worden standaard niet uitgelijnd, de tekst die na een afbeelding volgt wordt eronder geplaatst. Om een afbeelding links of rechts uit te lijnen kan met de rechtermuisknop op de afbeelding worden geklikt en in vervolgens gekozen worden voor \emph{Eigenschappen afbeelding}.\\
\includegraphics[scale=0.4]{img/ckeditor_rechter_muisknop.png}

Er verschijnt een popup en links onderin staat een \emph{Uitlijning} select-veld waarin gekozen kan worden voor \emph{$<$niet ingevuld$>$}, \emph{Links} of \emph{Rechts}.\\
\includegraphics[scale=0.4]{img/ckeditor_afbeelding_bewerken.png}


% paragraph afbeeldingen_uitlijnen (end)


\paragraph{Media en contentdeling}

Bestanden die op de server worden gezet zijn gekoppeld aan de subsite waar deze zijn toegevoegd. In de bibliotheek zijn alleen de bestanden te vinden die zijn toegevoegd op het huidige domein. Het is dus niet mogelijk om een bestand van het intranet op het internet te gebruiken en vice versa. 
Uitzondering hierop is wanneer de node gekoppeld wordt aan meerdere domeinen. Het bestand wordt dan toegankelijk gemaakt om alle subsites waar de node is gepubliceerd. In de bibliotheek is het bestand echter nog steeds alleen op het oorspronkelijke domein te vinden.
