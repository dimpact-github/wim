...
Het uitgangspunt is dat het automatische pad gehanteerd wordt, maar indien dit onwenselijke resultaten oplevert dan is het voor redacteuren wel mogelijk om dit pad aan te passen. Klik hiervoor bij het toevoegen of bewerken van inhoud op \emph{URL-pad-instellingen} (onderaan de pagina). Daar staat een checkbox die aangeeft dat er een automatische URL gebruikt wordt. Na het uitvinken hiervan kan eronder in een tekstveld een eigen pad worden aangegeven. Vul hiervoor het pad in zonder domeinnaam. Laat ook de eerste en laatste slash weg. Dus \texttt{agenda/collecte} maakt de pagina beschikbaar op \texttt{\customerdomain /acties/collecte}. Dit pad is relatief t.o.v. de huidige subsite. Dus de alias \texttt{agenda/collecte} op de subsite reizigers heeft als URL \texttt{\customerdomain /subsite/agenda/collecte}. Deze optie wordt dan ook \emph{niet} gebruikt om inhoud op andere domeinen beschikbaar te maken. Gebruik daarvoor de optie \emph{contentdeling}\seeone{contentdeling}.
