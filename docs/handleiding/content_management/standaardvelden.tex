...
\subsubsection{URL-omleidingen} % (fold)
\label{ssub:url_omleidingen}
Als inhoud is aangemaakt kunnen er \emph{URL-omleidingen} gemaakt worden. Dit zijn alternatieve paden die verwijzen naar dezelfde locatie. Bij het bewerken van inhoud is er een tab \emph{URL-omleidingen} waar bestaande omleidingen worden weergegeven en nieuwe kunnen worden toegevoegd.

Voor iedere bestaand pad (niet alleen voor nodes) kan een omleiding worden opgegeven, dit kan onder \emph{Zoeken en metadata} $\to$ \emph{URL-omleidingen}. Hier is ook een overzicht van alle omleidingen te vinden.

Voor het aanmaken van URL-omleidingen gelden dezelfde regels over speciale tekens als bij een URL alias (zie \ref{alias}).
% subsubsection url_omleidingen (end)
