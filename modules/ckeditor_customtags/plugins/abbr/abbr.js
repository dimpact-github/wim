...
CKEDITOR.plugins.add('ckeditor_abbrbutton', {
	init: function( editor ) {
		...
		CKEDITOR.dialog.add('abbrDialog', function(editor) {
			...
			return {
						onOk : function() {
                          ...
                          if(abbrTitle != '') {
                            var newElement = '<abbr title="' + abbrTitle + '">' + abbrDisplay + '</abbr>';
                          }
                          else {
                            var newElement = '<abbr>' + abbrDisplay + '</abbr>';
                          }
		...
		editor.ui.addButton('ckeditor_abbrbutton', {
			...
			icon: '/sites/all/modules/custom/ckeditor_customtags/plugins/abbr/abbr.png'
		}); 
	}
